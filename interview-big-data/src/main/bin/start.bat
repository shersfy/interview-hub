...
if not %v1% equ %v2% (
	echo error: big data rely on JRE version least is 1.8
	pause
)

echo Welcome to big data
echo %DATE:~0,10% %TIME:~0,8% big data is running...
"%javahome%/bin/java" -cp lib/*;./ org.interview.big.data.mapreduce.APP
pause